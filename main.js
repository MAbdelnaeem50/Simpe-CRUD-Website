...
function displayProducts(ps) {
    ...
    for (i = 0; i < ps.length; i++) {
        ...
        <td><button onclick ='productUpdate(${i});' style='padding:5px 10px ; background-color:white ;  color:black ; border-radius : 10px'>Update</button></td>
        <td><button onclick ='productDelete(${i});' style='padding:5px 10px ; background-color:#6c0c0c ; color:white ; border-radius : 10px'>Delete</button></td>
        </tr>
        `
    }
